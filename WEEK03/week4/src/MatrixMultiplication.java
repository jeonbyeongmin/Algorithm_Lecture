...
public class MatrixMultiplication {
    public static void main(String[] args) throws IOException {
        ...
        if (inputNumber == 1){
            ...
            System.out.println("[ A행렬과 B행렬을 곱한 값을 출력합니다. ]");
            ...
            System.out.println();
            System.out.println("Divide and conquer 수행시간 : " + time + " sec");
        }
            ...
            System.out.println();
            System.out.println("Strassen 수행시간 : " + time + " sec");
        } else{
    ...
    static void combine(int[][] dividedMatrix, int[][] combinedMatrix, int row, int column) {
